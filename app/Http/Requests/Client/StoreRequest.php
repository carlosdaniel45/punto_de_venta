...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'dni'=>'string|required|unique:produdcts|max:8',
            'ruc'=>'string|required|unique:produdcts|max:11',
            'address' =>'string|required|max:255', 
            'phone'=>'string|required|unique:produdcts|max:9',
            'email'=>'string|required|unique:produdcts|max:255|email:rfc,dns',
        ];
    }
